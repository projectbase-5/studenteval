...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ScholarSense — Student Performance Prediction System" },
      ...
      { name: "twitter:title", content: "ScholarSense — Student Performance Prediction System" },
